...
export module md5 {
    ...
    */
    export function hex_md5(s: string) { return rstr2hex(rstr_md5(str2rstr_utf8(s))); }//这个函数就行了，
    ...
    export function hex_hmac_md5(k: string, d: string) { return rstr2hex(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
    function b64_hmac_md5(k: string, d: string) { return rstr2b64(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
    function any_hmac_md5(k: string, d: string, e: string) { return rstr2any(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d)), e); }
